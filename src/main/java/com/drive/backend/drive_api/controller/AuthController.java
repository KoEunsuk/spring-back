...
public class AuthController {
    ...
    // 회원가입 API
    @PostMapping("/signup")
    public ResponseEntity<ApiResponse<UserDetailDto>> signup(@Valid @RequestBody SignupRequestDto signupDto) {
        UserDetailDto createdUser = authService.signup(signupDto);
